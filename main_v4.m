...
function [T,Pv,X,U,vl,O,S_k_mon] = main_v3(ReceiPos,SampFreq,PrevData)
...
NumElem = 10; % Number of discretization of the object
v0 = 10;
dt = T(2) - T(1);
c0 = 340;
...
for kk = 1:length(T)
   ...
   pl = zeros(1,NumElem);
   for ll = 1:NumElem
      [S_k(ll),gl_g(kk,ll,:)] = CompGFunc(ObjSpeed(ll),v0,dt,S_k(ll));
